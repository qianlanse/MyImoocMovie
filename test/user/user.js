...
describe('<Unit Test',function(){
	describe('Model User:',function(){
		...
		describe('User save',function(){
			it('should save without problems',function(done){ //确定保存无误
			...
			it('should password be hashed correctly',function(done){ //确定保存无误
			...
			it('should hava default role 0',function(done){ //确定权限初始为零
				var _user = new User(user);
				_user.save(function(err){
			...
			it('should fail to save an existing user',function(done){ //确定权限初始为零
